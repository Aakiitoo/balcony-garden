...
export const plantCatalog: PlantCatalog[] = [
  ...
  },
  {
    ...
    sunlightHours: "6–8 hours",
    sunlightType: "direct",
    sunlightNotes: "Needs warmth; large leaves need space on a balcony.",
    waterFrequency: "Daily in hot weather",
    waterNotes: "Heavy drinker; mulch to reduce evaporation.",
    potSizeMinLiters: 20,
    potSizeNotes: "20L+ per plant; bush varieties suit pots best.",
    growingTips: "Harvest small fruits often to keep plants productive.",
  },
  {
    id: 10,
    name: "Eggplant",
    ...
    sunlightHours: "6–8 hours",
    sunlightType: "direct",
    sunlightNotes: "Heat-loving; protect from cold wind.",
    waterFrequency: "Every 2–3 days",
    waterNotes: "Even moisture; stress causes bitter fruit.",
    potSizeMinLiters: 15,
    potSizeNotes: "15L minimum per plant.",
    growingTips: "Stake when fruit sets. Slow in cool summers.",
  },
  {
    id: 11,
    name: "Spinach",
    ...
    sunlightHours: "4–6 hours",
    sunlightType: "partial",
    sunlightNotes: "Bolts in hot direct sun; spring and autumn best.",
    waterFrequency: "Keep soil moist",
    waterNotes: "Shallow roots; dries out quickly in small pots.",
    potSizeMinLiters: 3,
    potSizeNotes: "Wide shallow pots work well.",
    growingTips: "Succession sow for continuous harvest.",
  },
  {
    id: 12,
    name: "Kale",
    ...
    sunlightHours: "4–6 hours",
    sunlightType: "partial",
    sunlightNotes: "Tolerates partial shade; flavor sweeter after light frost.",
    waterFrequency: "Every 1–2 days in summer",
    waterNotes: "Consistent moisture prevents bitterness.",
    potSizeMinLiters: 5,
    potSizeNotes: "5L+ per plant; several in one large trough OK.",
    growingTips: "Pick lower leaves first.",
  },
  {
    id: 13,
    name: "Green beans",
    ...
    sunlightHours: "6+ hours",
    sunlightType: "direct",
    sunlightNotes: "Bush types for pots; pole types need a trellis.",
    waterFrequency: "Regular; avoid drying out when flowering",
    waterNotes: "Irregular water causes flower drop.",
    potSizeMinLiters: 10,
    potSizeNotes: "10L+ for bush beans.",
    growingTips: "Do not over-fertilize with nitrogen.",
  },
  {
    id: 14,
    name: "Parsley",
    ...
    sunlightHours: "4–6 hours",
    sunlightType: "partial",
    sunlightNotes: "Morning sun ideal on hot balconies.",
    waterFrequency: "Every 1–2 days",
    waterNotes: "Do not let pot dry completely.",
    potSizeMinLiters: 3,
    potSizeNotes: "3–5L; deep pot helps root development.",
    growingTips: "Slow to germinate; patience on first sowing.",
  },
  {
    id: 15,
    name: "Chives",
    ...
    sunlightHours: "4–6 hours",
    sunlightType: "partial",
    sunlightNotes: "Tolerates partial shade.",
    waterFrequency: "Every 2–3 days",
    waterNotes: "Moderate water; good drainage.",
    potSizeMinLiters: 3,
    potSizeNotes: "3L+; clumps can stay in same pot for years.",
    growingTips: "Cut regularly to encourage new growth.",
  },
  {
    id: 16,
    name: "Rosemary",
    ...
    sunlightHours: "6+ hours",
    sunlightType: "direct",
    sunlightNotes: "Needs sun and airflow; avoid overcrowding.",
    waterFrequency: "Let soil dry between waterings",
    waterNotes: "Drought-tolerant when established; hates wet feet.",
    potSizeMinLiters: 5,
    potSizeNotes: "5L+ with grit for drainage.",
    growingTips: "Do not overwater in winter.",
  },
  {
    id: 17,
    name: "Raspberry",
    ...
    sunlightHours: "6+ hours",
    sunlightType: "direct",
    sunlightNotes: "Dwarf patio varieties suit balconies.",
    waterFrequency: "Every 1–2 days when fruiting",
    waterNotes: "Consistent moisture for berry development.",
    potSizeMinLiters: 15,
    potSizeNotes: "15L+ per cane cluster.",
    growingTips: "Prune after fruiting per variety instructions.",
  },
  {
    id: 18,
    name: "Lemon tree",
    ...
    sunlightHours: "6–8 hours",
    sunlightType: "direct",
    sunlightNotes: "Bring indoors or shelter below 5°C.",
    waterFrequency: "When top soil dries",
    waterNotes: "Reduce in winter; citrus feed in growing season.",
    potSizeMinLiters: 25,
    potSizeNotes: "25L+ for mature patio trees.",
    growingTips: "Citrus-specific fertilizer spring–autumn.",
  },
];
